...
function init()
  ...
  vipButton = modules.client_topmenu.addCustomRightButton('vipListButton', tr('VIP List') .. ' (Ctrl+F)', '/images/ui/pxg/topMenu_icons/friend_icon', toggle, false)
...
function toggle()
  if vipButton:isOn() then
    ...
    vipButton:setIcon('/images/ui/pxg/topMenu_icons/friend_icon_apagado')
  else
    vipWindow:open()
    vipButton:setOn(true)
    vipButton:setIcon('/images/ui/pxg/topMenu_icons/friend_icon')
  end
end
